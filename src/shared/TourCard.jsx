        ...
        <div>
            <div className="rounded-md bg-white border border-primary text-secondaryV shadow-lg">
                ...
                <div className="flex justify-end p-6 pt-0">
                    <a href="details" class="relative inline-flex items-center px-12 py-2 overflow-hidden text-lg font-medium text-primaryV border-2 border-primaryV rounded-full hover:text-white group hover:bg-gray-50">
