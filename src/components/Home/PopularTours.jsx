            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className='group relative items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 cursor-pointer rounded-xl'>
                    <div className='h-[450px] md:h-[550px] w-full relative'>
                        ...
                        <h3 className='absolute text-primary uppercase font-medium inline-block top-4 left-3 py-1 px-4 bg-primaryV rounded-xl'>Special</h3>
                    </div>
                    <div className='absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70'></div>
                    <div className='absolute inset-0 flex flex-col justify-center px-10 translate-y-[48%] group-hover:translate-y-[30%] transition-all duration-300'>
                        ...
                        <div className='flex justify-between mt-6'>
                            ...
                            <div className='min-h-10 flex flex-col justify-between'>
                                <del className='text-secondaryV'>$2000</del>
                                <h2 className='text-primary text-xl lg:text-2xl font-semibold'>$1500</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='group relative items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 cursor-pointer rounded-xl'>
                    <div className='h-[450px] md:h-[550px] w-full relative'>
                        ...
                        <h3 className='absolute text-primary uppercase font-medium inline-block top-4 left-3 py-1 px-4 bg-primaryV rounded-xl'>20% off</h3>
                    </div>
                    <div className='absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70'></div>
                    <div className='absolute inset-0 flex flex-col justify-center px-10 translate-y-[48%] group-hover:translate-y-[30%] transition-all duration-300'>
                        <h2 className='text-2xl lg:text-3xl font-bold text-white'>
                ...
                <div className='block lg:hidden group relative items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 cursor-pointer rounded-xl'>
                    <div className='h-[450px] md:h-[550px] w-full relative'>
                        <img className='h-[450px] md:h-[550px] w-full object-cover rounded-xl ' src="https://i.ibb.co/yk6jGmV/asset-13.jpg" alt="" />
                        <h3 className='absolute text-primary uppercase font-medium inline-block top-4 left-3 py-1 px-4 bg-primaryV rounded-xl'>20% off</h3>
                    </div>
