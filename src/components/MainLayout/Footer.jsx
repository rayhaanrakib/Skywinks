        ...
        <div className='bg-secondary'>
            <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto ">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
                    ...
                    <div>
                        <h4 class="text-xs font-semibold text-primary uppercase">Product</h4>

                        <div class="mt-3 grid space-y-3 text-sm">
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Pricing</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Changelog</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Docs</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Download</a></p>
                        </div>
                    </div>

                    <div>
                        <h4 class="text-xs font-semibold text-primary uppercase ">Company</h4>
                        ...
                        <div class="mt-3 grid space-y-3 text-sm">
                            ...
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Careers</a> <span class="inline text-blue-600 dark:text-blue-500">— We're hiring</span></p>
                            ...
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Sitemap</a></p>
                        </div>
                    </div>

                    <div>
                        <h4 class="text-xs font-semibold text-primary uppercase ">Resources</h4>

                        <div class="mt-3 grid space-y-3 text-sm">
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Community</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Help & Support</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">eBook</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">What's New</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Status</a></p>
                        </div>
                    </div>

                    <div>
                        <h4 class="text-xs font-semibold text-primary uppercase ">Developers</h4>

                        <div class="mt-3 grid space-y-3 text-sm">
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Api</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Status</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">GitHub</a> <span class="inline text-blue-600 dark:text-blue-500">— New</span></p>
                        </div>

                        <h4 class="mt-7 text-xs font-semibold text-primary uppercase ">Industries</h4>

                        <div class="mt-3 grid space-y-3 text-sm">
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Financial Services</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-accent" href="#">Education</a></p>
                        </div>
                    </div>
                </div>

                <div class="pt-5 mt-5 border-t border-secondaryV ">
